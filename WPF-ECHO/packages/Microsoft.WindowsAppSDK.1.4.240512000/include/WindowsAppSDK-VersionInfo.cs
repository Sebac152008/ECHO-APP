...
namespace Microsoft.WindowsAppSDK
{
    ...
    namespace Runtime
    {
        ...
        internal class Version
        {
            ...
            internal const ushort Minor = 1227;

            /// The build version of the Windows App SDK runtime; for example, 804.
            internal const ushort Build = 1637;
            ...
            internal const ulong UInt64 = 0x0FA004CB06650000;

            /// The version of the Windows App SDK runtime, as a string (const wchar_t*); for example, "1000.446.804.0".
            internal const string DotQuadString = "4000.1227.1637.0";
        }
        ...
        namespace Packages
        {
            ...
            namespace DDLM
            {
                internal class X86
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.4000.1227.1637.0-x8_8wekyb3d8bbwe";
                }
                internal class X64
                {
                    /// The Windows App SDK runtime's Dynamic Dependency Lifetime Manager (DDLM) package's family name, for x64.
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.4000.1227.1637.0-x6_8wekyb3d8bbwe";
                }
                internal class Arm64
                {
                    ...
                    internal const string PackageFamilyName = "Microsoft.WinAppRuntime.DDLM.4000.1227.1637.0-a6_8wekyb3d8bbwe";
                }
            }
        }
    }
